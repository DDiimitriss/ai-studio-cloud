...
def generate_3d(prompt):
    """Talks to the 3D factory (Using the standard Hunyuan3D)"""
    url = "https://queue.fal.run/fal-ai/hunyuan3d"
    ...
    try:
        ...
        status_url = f"https://queue.fal.run/fal-ai/hunyuan3d/requests/{request_id}/status"
        result_url = f"https://queue.fal.run/fal-ai/hunyuan3d/requests/{request_id}"
